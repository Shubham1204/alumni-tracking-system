...
<div class='w-100 float-right pr-2'>
	<h1 class='text-center btn btn-outline-success w-100 display-1'>Add Event</h1>
	<form action="addevent" method="post">
		<div class='form-group'>
			<label>Event Name</label>
			<input class='form-control' type='text' name='eventname' placeholder='Enter the Event Name'>
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			...
			<input class='form-control' type='date' name='date' placeholder='Enter the Date'>
		</div>
		<div class='form-group'>
			<label>Event Time</label>
			<input class='form-control' type='time' name='time' placeholder='Enter the Time'>
		</div>
		<div class='form-group'>
			<label>Contact No.</label>
			<input class='form-control' type='text' name='contact' placeholder='Enter the Contact No.'>		
		</div>
		<div class='form-group'>
			<label>Email</label>
		...
		<div class='form-group'>
			...
			<input class='form-control' type='text' name='venue' placeholder='Enter the Venue'>
		</div>
		<div>
		...
		<div class='form-group'>
			<button type="submit" name="addeventbtn" value="addeventbtn" class='btn btn-primary'>Add Event</button>
		 </div>
	</form>
</div>
  </main>
