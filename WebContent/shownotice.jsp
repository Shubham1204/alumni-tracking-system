<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="java.util.ArrayList,com.shubham.ats.dto.userDTO,com.shubham.ats.dto.rightsDTO,com.shubham.ats.dto.noticeDTO"%>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 overflow-auto mb-5">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Existing Notices</h1>
      </div>
<div class='w-100 float-right pr-2'>
	<h1 class='text-center btn btn-outline-success w-100 display-1'>Show Notices</h1>
	<table class='table table-bordered'>
			...
			<tbody>
				<%
				ArrayList<noticeDTO> noticelist = (ArrayList<noticeDTO>)request.getAttribute("noticedata");
				
					if(noticelist!=null){
						for(noticeDTO obj : noticelist){
							/* if(rolerightlist.iterator().next().getRolename()==obj.getRolename()){ */
								%>
								<tr>
								<td><%=obj.getNoticeid() %></td>
								<td><%=obj.getNoticesubject() %></td>
