<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="java.util.ArrayList,com.shubham.ats.dto.userDTO,com.shubham.ats.dto.rightsDTO,com.shubham.ats.dto.collegeDTO"%>
...
<div class='w-100 float-right pr-2'>
	...
	<table class='table table-bordered'>
			...
			<tbody>
				<%
				ArrayList<collegeDTO> collegelist = (ArrayList<collegeDTO>)request.getAttribute("collegedata");
				
					if(collegelist!=null){
						for(collegeDTO obj : collegelist){
							/* if(rolerightlist.iterator().next().getRolename()==obj.getRolename()){ */
								%>
								<tr>
								<td><%=obj.getCollegeid() %></td>
								<td><%=obj.getCollegename() %></td>
