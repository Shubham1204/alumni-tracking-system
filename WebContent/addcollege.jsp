  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 overflow-auto mb-5">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Add College</h1>
      </div>
<div class='w-100 float-right pr-2'>
	<h1 class='text-center btn btn-outline-success w-100 display-1'>Add College</h1>
	<form action="addcollege" method="post">
		<div class='form-group'>
			<label>College Name</label>
			<input class='form-control' type='text' name='cllgname' placeholder='Enter the College Name'>
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			...
			<input class='form-control' type='text' name='cllgaddress' placeholder='Enter the Address'>		
		</div>
		<div>
		...
		<div class='form-group'>
			<button type="submit" name="addcollegebtn" value="addcollegebtn" class='btn btn-primary'>ADD College</button>
		 </div>
	</form>
</div>
  </main>
