...
<div class='w-100 float-right pr-2'>
	<h1 class='text-center btn btn-outline-success w-100 display-1'>Send Message</h1>
	<form action="sendmessage" method="post">
		<div class='form-group'>
			<label>Sender's Contact No.</label>
			<input class='form-control' type='tel' name='scontact' placeholder='Enter the Senders Contact No.'>		
		</div>
		<div class='form-group'>
			<label>Reciever's Contact No.</label>
			<input class='form-control' type='tel' name='rcontact' placeholder='Enter the Recievers Contact No.'>		
		</div>
		<div class='form-group'>
		...
		<div class='form-group'>
			<button type="submit" name="addmessagebtn" value="addmessagebtn" class='btn btn-primary'>Send Message</button>
		 </div>
	</form>
</div>
  </main>
