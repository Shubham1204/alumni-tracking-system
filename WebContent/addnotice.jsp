...
<div class='w-100 float-right pr-2'>
	<h1 class='text-center btn btn-outline-success w-100 display-1'>Add Notice</h1>
	<form action="addnotice" method="post">
		...
		<div class='form-group'>
			<button type="submit" name="addnoticebtn" value="addnoticebtn" class='btn btn-primary'>Add Notice</button>
		 </div>
	</form>
</div>
  </main>
