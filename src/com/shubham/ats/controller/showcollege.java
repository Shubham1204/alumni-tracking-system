...
public class showcollege extends HttpServlet {
...
//			request.setAttribute("rightdata", rightslist);
			ArrayList<collegeDTO> collegelist =  collegeDAO.showcollege();
			request.setAttribute("collegedata", collegelist);
			...
			RequestDispatcher rd = request.getRequestDispatcher("showcollege.jsp");
