...
import com.shubham.ats.dao.rolerightDAO;
...
//			request.setAttribute("rightdata", rightslist);
			ArrayList<rolerightDTO> rolerightlist = rolerightDAO.existingroleright();
			request.setAttribute("rolerightdata", rolerightlist);
			...
			RequestDispatcher rd = request.getRequestDispatcher("showrole.jsp");
