...
//			request.setAttribute("rightdata", rightslist);
			ArrayList<emailDTO> emaillist =  emailDAO.showemail();
			request.setAttribute("emaildata", emaillist);
			...
			RequestDispatcher rd = request.getRequestDispatcher("showemail.jsp");
